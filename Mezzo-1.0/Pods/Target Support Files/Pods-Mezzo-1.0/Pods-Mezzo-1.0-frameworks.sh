...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework 'Pods-Mezzo-1.0/NSDate_Helper.framework'
  install_framework 'Pods-Mezzo-1.0/Parse.framework'
  install_framework 'Pods-Mezzo-1.0/ParseUI.framework'
  install_framework 'Pods-Mezzo-1.0/RMActionController.framework'
  install_framework 'Pods-Mezzo-1.0/RMDateSelectionViewController.framework'
fi
